...
import com.example.demoewallet.app.binding.bindNullableNumberConstant
import com.example.demoewallet.app.binding.bindNumberConstant
...
fun Module.constant(name: String):Constant{
    Log.d("Module.constant", "constant:name: $name")
    return constantOrNull(name) ?: throw NoSuchElementException()
}
